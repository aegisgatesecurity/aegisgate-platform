...
In another embodiment, the capability types include at least: file read, file write, file delete, file execute, database read, database write, database delete, network HTTP access, network HTTPS access, internal network access, external network access, internal API call, external API call, agent-to-agent call, agent delegation, agent spawn, data export, PII data access, sensitive data access, terminal command execution, SSH terminal access, and administrative access.
...
3. The system of claim 1, wherein the capability contracts comprise a set of permitted action types selected from at least: file read, file write, file delete, file execute, database read, database write, database delete, network HTTP access, network HTTPS access, internal network access, external network access, internal API call, external API call, agent-to-agent call, agent delegation, agent spawn, data export, PII data access, sensitive data access, terminal command execution, SSH terminal access, and administrative access.
