...
1. **Keyboard Walk Reverse Mapping:** A 50-entry map (25 lowercase + 25 uppercase entries covering 3 QWERTY rows) that reverses QWERTY right-shift keyboard walk encoding (e.g., "djj" → "ash") to detect obfuscated patterns.
