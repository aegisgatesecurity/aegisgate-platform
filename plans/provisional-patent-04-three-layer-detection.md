...
In another embodiment, the compliance and adversarial technique classification layer maps detected patterns to MITRE ATLAS adversarial techniques and 30+ compliance framework controls.

In another embodiment, the machine learning layer uses a CharCNN-BiLSTM with 1,596,034 parameters, trained on a corpus of 70,572 adversarial and benign AI prompts, with an evasion resistance score of 99.8 out of 100 across 2,600 adversarial test cases (52 MITRE ATLAS payloads × 50 transforms) and a calibrated false positive rate of 0% on benign corpus using threshold calibration.
...
#### Compliance Framework Mapping (30+ frameworks)
...
- **Final Performance:** 99.8/100 evasion resistance across 2,600 adversarial test cases (52 MITRE ATLAS payloads × 50 transforms), calibrated 0% false positive rate on benign corpus.
...
8. The pipeline of claim 1, wherein the compliance classification layer maps detections to MITRE ATLAS adversarial techniques and 30+ compliance frameworks.

9. The pipeline of claim 2, wherein the keyboard walk reverse mapping uses a 50-entry map (25 lowercase + 25 uppercase) reversing QWERTY right-shift encoding.

10. The pipeline of claim 4, wherein the model is trained on a corpus of 70,572 labeled AI prompts with 50 data augmentation transform types, achieving 99.8/100 evasion resistance across 2,600 adversarial test cases and a calibrated 0% false positive rate on benign corpus.
