...
| v3.6.0 (current) | 5 auth bypass fixes, localhost-only metrics, CSP hardening, HA clustering |
| v3.6.0 (planned) | Add Art 27 fundamental rights impact assessment template; integrate with the Trust Framework for cryptographic evidence attestation |
