...
**Status:** v3.6.0 (shipped 2026-08-01, security hardening + ML pipeline)  
...
| **v3.6.0** (current) | **Trust Framework promoted to 6th pillar; HTTP API at `/api/v1/trust/*`; tier-gated to Professional+ per locked decision Q3** |
