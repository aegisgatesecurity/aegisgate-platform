...
**Status:** v3.4.0+ (shipped 2026-07-20, D16 work)  
...
| **v3.4.0+** (this release) | **Trust Framework promoted to 6th pillar; HTTP API at `/api/v1/trust/*`; tier-gated to Professional+ per locked decision Q3** |
