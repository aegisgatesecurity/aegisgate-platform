# AegisGate Platform API Reference — v4.3.0+ (still applicable in v4.4.1)

This document covers the REST API endpoints added in v4.3.0+ (still applicable in v4.4.1) for the
