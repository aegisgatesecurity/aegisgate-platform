...
### 1.3 Service Level Agreement Targets

The following SLA targets govern incident response timelines across all severity levels:

| Severity | Initial Response | Status Updates | Resolution Target | Escalation |
|----------|----------------|---------------|-------------------|------------|
| **Critical (P1)** | 1 hour | Every 2 hours | 4 hours | VP Engineering + CISO within 30 minutes |
| **High (P2)** | 4 hours | Every 8 hours | 24 hours | Engineering Lead within 2 hours |
| **Medium (P3)** | 24 hours | Every 24 hours | 72 hours | Engineering Lead within 8 hours |
| **Low (P4)** | 72 hours | Weekly | 30 days | Standard queue |

**Initial Response** is defined as: acknowledgment of the incident, assignment of a responder, and commencement of triage.

**Resolution Target** is defined as: the incident is contained, root cause is identified, and remediation is in progress or complete.

**SLA clocks start** when the incident is reported through any official channel (security@aegisgatesecurity.io, PGP-encrypted email, or customer portal).

**Tier-specific SLA guarantees:**

| Tier | P1 Response | P2 Response | P3 Response | P4 Response |
|------|-------------|-------------|-------------|-------------|
| Community | Best effort | Best effort | Best effort | Best effort |
| Starter | 8 hours | 24 hours | 72 hours | 7 days |
| Developer | 4 hours | 8 hours | 24 hours | 72 hours |
| Professional | 1 hour | 4 hours | 24 hours | 72 hours |
| Enterprise | 1 hour | 2 hours | 8 hours | 24 hours |

### 1.4 Post-Incident Review

All P1 (Critical) and P2 (High) incidents require a formal post-incident review within 5 business days of resolution. The review must include:

1. **Timeline reconstruction** — exact sequence of events from detection to resolution
2. **Root cause analysis** — primary cause and contributing factors
3. **Impact assessment** — affected systems, data, and customers
4. **Response evaluation** — SLA adherence, what worked, what didn't
5. **Remediation actions** — completed and planned corrective actions
6. **Lessons learned** — process improvements and detection pattern updates

P3 (Medium) incidents require a written summary within 10 business days. P4 (Low) incidents are tracked in the quarterly incident report.
