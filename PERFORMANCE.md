...
> For the **current v3.2.0 release**, see [`README.md`](README.md) and the [latest GitHub release](https://github.com/aegisgatesecurity/aegisgate-platform/releases/latest).
>
> **Version**: 3.0.0  
> **Date**: 2026-05-19  
