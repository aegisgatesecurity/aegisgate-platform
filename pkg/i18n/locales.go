...
func LoadEmbedded() (map[Locale]*LocaleFile, error) {
	...
	localeFiles := []struct {
		...
		{LocaleAr, "locales/ar.json"},
		{LocaleRu, "locales/ru.json"},
		{LocaleHe, "locales/he.json"},
		{LocaleHi, "locales/hi.json"},
		{LocalePt, "locales/pt.json"},
		{LocaleKo, "locales/ko.json"},
	}
...
// ListEmbeddedLocales returns all embedded locales. Matches the
// locale files loaded by LoadEmbedded.
