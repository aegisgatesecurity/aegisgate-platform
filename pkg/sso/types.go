...
type SSOUser struct {
	...
	Name string
	// Role is the user's role (admin, operator, viewer, etc.)
	Role          string
...
// RoleAtLeast checks if the user's role meets or exceeds the required role
func (u *SSOUser) RoleAtLeast(required string) bool {
