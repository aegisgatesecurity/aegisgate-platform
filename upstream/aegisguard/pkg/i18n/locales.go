// Package i18n provides internationalization (i18n) support for AegisGuard.
// Manages translations and locale-specific formatting for the AI Agent Security Platform.
package i18n
